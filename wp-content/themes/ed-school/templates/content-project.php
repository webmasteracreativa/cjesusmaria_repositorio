...
<div class="teacher one third wh-padding">
	<div class="thumbnail">
		<?php ed_school_get_thumbnail( array('thumbnail' => 'ed-school-featured-image' ) ); ?>
	</div>
	<div class="item">
		...
		<?php if ( $summary ) : ?>
			<div
				class="summary"><?php echo wp_trim_words( do_shortcode( $summary ), apply_filters( 'ed_school_project_summary_word_count', 10 ) ); ?></div>
		<?php else: ?>
