...
// WRAPPER
echo "<div class=\"slide slide1 testimonial_rotator_slide testimonial_rotator testimonial_rotator_single template-{$template_name} hreview itemreviewed item {$has_image} cf-tr\">\n";	
